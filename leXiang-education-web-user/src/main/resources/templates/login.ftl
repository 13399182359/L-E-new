    ...
    <div class="body01-content">
        <ul>
            <li>
                ...
                <div class="title">
                    <h5><a href="http://try.51eduline.com/course/178.html">JAVA</a></h5>
                    <span><strong> ￥100</strong><small>100人购买</small></span>
                </div>
            </li>

            <#list   videoAll as  video  >
                <li>
                    <img class="lefttopimg" src="http://try.51eduline.com/addons/theme/stv1/_static/images/course.png"
                         alt="">
                    ...
                    <div class="title">
                        <h5><a href="http://try.51eduline.com/course/176.html">${video.playname}</a></h5>
                        <span><strong> ￥${video.price}</strong><small>${video.studentcount}人购买</small></span>
                    </div>
                </li>
