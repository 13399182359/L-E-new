...
<div id="transparent" style="display: none;">
    ...
    <div id="loging-worap-regsiter"><a class="loging-Cancel" href="javascript:;" onclick="removeReg()">×</a>
        <!--登录-->
        <div id="loging-worap">
            <div class="title">登录2</div>
            <div class="loging" style="padding:0 20px;margin:0;width:auto;border:0">
                <form id="userLogin" action="/userLogin">
                    <ul>
                        <li class="her-login">
                            <div class="input-box">
                                <i class="icon-zhanghao"></i>
                                <input name="username" id="username" class="regsiter-width" maxlength="30" type="text" placeholder="请输入用户名/手机号/邮箱">
                                <em>×</em>
                            </div>
                        </li>
                        <li class="her-login">
                            <div class="input-box">
                                <i class="icon-mima"></i>
                                <input name="encodedPassword" id="encodedpassword" class="regsiter-width" maxlength="30" type="password" placeholder="请输入登录密码">
                                <em>×</em>
                            </div>
                        </li>
                        <li class="her-login">
                            <input name="" id="logSub"class="loging-xy-submit" type="submit" value="登录"/>
                        </li>
                    </ul>
                </form>
                <div class="loging-xy">
    ...
    <div class="header_new2">
        ...
        <div class="top3">
            ...
            <div class="search_index">
                ...
                <p class="bd_right"></p>
                <input type="text" id="search_combo_input" name="playname" placeholder="搜索课程">
                    ...
                    $('#btn_search_site').click(function(){
                        ...
                        if(search_combo_input != ''){
                            if(search_cate == 'video'){
                                location.href="toVideoSource?search="+search_combo_input;
                                window.open("videoSource.html"+"?search="+search_combo_input);
                               // esQuery(search_combo_input);
            ...
            <div class="nav1">
                ...
                <ul class="page_header_adiv">
                    ...
                    <li>
                        <a href="http://try.51eduline.com/register.html">注册</a>
                    </li>     </ul>
            </div>
...
<link rel="stylesheet" type="text/css" href="http://try.51eduline.com/addons/theme/stv1/_static/css/swiper_banner.css">
<link rel="stylesheet" type="text/css" href="http://try.51eduline.com/addons/theme/stv1/_static/css/slider_banner.css">
<script src="http://try.51eduline.com/addons/theme/stv1/_static/js/swiper.min.js"></script>
...
<!--banner start-->
<section>
    <div class="swiper-container section-banner">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <a href="https://t.v4.51eduline.com/live.html" title="">
                    <img src="http://try.51eduline.com/data/upload/2018/12/045c065c46e9d53_1920_420_1920_420.png" alt="" >
                </a>
            </div><div class="swiper-slide">
                <a href="/" title="">
                    <img src="http://try.51eduline.com/data/upload/2018/12/045c065c4a64228_1920_420_1920_420.png" alt="" >
                </a>
            </div><div class="swiper-slide">
                <a href="/" title="">
                    <img src="http://try.51eduline.com/data/upload/2018/12/045c065c522ccab_1920_420_1920_420.png" alt="" >
                </a>
            </div>                </div>
        <!-- Add Pagination -->
...
<div class="body01" style="margin:0 auto">
    ...
    <!-- <div class="hot-news">
         <h4>热门资讯：</h4>
         <ul>
             <li><i class="icon icon-dian"></i><a href="http://try.51eduline.com/news/59.html">和氧化吧女</a></li>                    </ul>
     </div>-->
</div>
        ...
        <ul>
            <li>
                ...
                <a href="http://try.51eduline.com/course/178.html">
                    <img class="lazyload" data-original="http://try.51eduline.com/data/upload/2019/10/165da6da07aa180_580_320_580_320.jpg" alt="" />
                </a>
                <div class="title">
                    <h5><a href="http://try.51eduline.com/course/178.html">
                            直播名字
                        </a></h5>
                    <span><strong>价格</strong><small>购买人数
                            studentcount</small>
                    </span>
                </div>
            </li>
            <li>
                ...
                <img class="lefttopimg" src="http://try.51eduline.com/addons/theme/stv1/_static/images/course.png"
                     alt="">
                <a href="http://try.51eduline.com/course/175.html">
                    <img class="lazyload" data-original="http://try.51eduline.com/data/upload/2019/10/125da192bb53207_580_320_580_320.jpg" alt="" />
                </a>
                <div class="title">
                    <h5><a href="http://try.51eduline.com/course/175.html">三组测试</a></h5>
                    <span><strong> ￥1000</strong><small>100787人购买</small></span>
                </div>
            </li><li>
                <img class="lefttopimg" src="http://try.51eduline.com/addons/theme/stv1/_static/images/course.png"
                     alt="">
                ...
                <div class="title">
                    ...
                    <span><strong><span style="color: #56b02a;">免费</span> </strong><small>189人购买</small></span>
                </div>
            </li><li>
                <img class="lefttopimg"  src="http://try.51eduline.com/apps/course/_static/icon/living.png" alt="">
                ...
                <div class="title">
                    ...
                    <span><strong><span style="color: #56b02a;">免费</span> </strong><small>172人购买</small></span>
                </div>
            </li>                </ul>
    </div>
    <!--查看更多-->
...
<div class="body01">
    ...
    <div class="information-new">
        <div class="information-banner">
            <div class="content">
                <div style="margin: 0" class="slider single-item">
                    <div>
                        <a href="http://try.51eduline.com/news/59.html"><img class="lazyload" data-original="http://try.51eduline.com/data/upload/2019/10/205dac08aaee7c4_570_360_570_360.jpg"></a>
                        <span><p>和氧化吧女</p></span>
                    </div>                        </div>
                <!--[if lte IE 9]>
    ...
    <!--查看更多-->
    <div class="all-buy">
        <a href="http://try.51eduline.com/news.html" class="look-all">查看更多</a>
    </div>
</div>
