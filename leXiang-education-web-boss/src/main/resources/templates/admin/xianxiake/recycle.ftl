...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            ...
            <li><a href="/courseCyq/findCourseStatus" class="on">回收站</a></li>
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="course_AdminLineClass_recycle"  class="s-txt"/>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_course_AdminLineClass_recycle" />
            <input type="hidden" name='pageTitle' value="回收站" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
    ...
    <div class="form2" id='search_form' >
        <form action="http://try.51eduline.com/index.php?app=course&mod=AdminLineClass&act=recycle&dosearch=1" method="post">
            <div class="page_btm">
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="admin.delLineClassAll('LineClass','delLineClassAll',2)" class="btn_a"><span>彻底删除</span></a>
    </div>
    <!-- END TOOLBAR -->
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <#list status.list as list>
                <tr>
                    ...
                    <td >
                        <a target="_blank" href=" http://try.51eduline.com/lineclass/34.html ">查看</a> |
                        <a href="http://try.51eduline.com/index.php?app=course&mod=AdminLineClass&act=reviewVideo&tabHash=reviewVideo&id=34">评价</a> |
                        <a href="/courseCyq/findCourseById?id=${list.id}">编辑</a> |
                        <a href="/courseCyq/statusCourseUpd?id=${list.id}">启用</a>
                    </td>
                </tr>
            </#list>
        </table>
    ...
    <#--<div class="Toolbar_inbox">
        <div class="page right"><span>共10条</span></div>
        <!-- 	<a onclick="admin.delLineClassAll('LineClass','delLineClassAll',2)" class="btn_a"><span>彻底删除</span></a> &ndash;&gt;
    </div>-->
    <!-- END BOTTOMBAR -->
</div>
<script>
