...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            ...
            <li><a href="/courseCyq/findCourseAudit" class="on">待审</a></li>
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="course_AdminLineClass_unauditList"  class="s-txt"/>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr overstyle="on">
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='订单数'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_course_AdminLineClass_unauditList" />
            <input type="hidden" name='pageTitle' value="" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
    ...
    <div class="form2" id='search_form' >
        <form action="http://try.51eduline.com/index.php?app=course&mod=AdminLineClass&act=unauditList&dosearch=1" method="post">
            <div class="page_btm">
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <#list courseAudit.list as audit>
                <tr>
                    <td>
                        <input type="checkbox" id="checkbox_handle" onclick="admin.checkAll(this)" value="0">
                    </td>
                    <td>${audit.id}</td>
                    <td>${audit.name}</td>
                    <td>${audit.img?default(" ")}</td>
                    <td>${audit.price}</td>
                    <td>${audit.userId?default(" ")}</td>
                    <td>${audit.lecturerId?default(" ")}</td>
                    <td>${audit.audit}</td>
                    <td>${audit.free}</td>
                    <td>${audit.createTime?date}</td>
                    <td>
                        <a href="/courseCyq/updCourseAudit?id=${audit.id}">审核通过</a>
                    </td>
                </tr>
            </#list>
        </table>
