...
<div id="container" class="so_main">
    <div class="tit_tab">
        <!-- START TAB框 -->
        <ul>
            <li><a href="/huiyuandengji/findXqHuiyuandengji" class="on">列表</a></li><li><a href="/huiyuandengji/toadd" >添加</a></li>
        </ul>                    <!-- END TAB框 -->
        ...
        <div id='page_config' class = "form2 list" >
            ...
            <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
                ...
                <input type="hidden" name='pageTitle' value="编辑会员等级-VIP" />
        ...
        <form method="POST" action="/huiyuandengji/updXqHuiyuandengji"  name='detail_form' style="margin-top:5px">
            <input type="hidden" name='id' value="${memberlv.id}" class="s-txt" />
            <input type="hidden" name='status' value="${memberlv.status}" class="s-txt" />
            <div class="form2">
                <dl class="lineD" id='dl_title'>
                    <dt><font color="red"> * </font>名称：</dt>
                    <dd>
                        <input name="name" id="form_title" type="text" value="${memberlv.name}"  class="s-txt" style='width:200px'>
                    </dd>
                </dl>
                <dl class="lineD" id='dl_sort'>
                    <dt><font color="red"> * </font>等级：</dt>
                    <dd>
                        <input name="grade" id="form_sort" type="text" value="${memberlv.grade}"  class="s-txt" style='width:200px'>
                        <p>数字越高，等级越高</p>
                    </dd>
                </dl>
                <dl class="lineD" id='dl_vip_month'>
                    <dt>月费：</dt>
                    <dd>
                        <input name="mouthprice" id="form_vip_month" type="text" value="${memberlv.mouthprice}"  class="s-txt" style='width:200px'>
                        <p>单位：元</p>
                    </dd>
                </dl>
                <dl class="lineD" id='dl_vip_year'>
                    <dt>年费：</dt>
                    <dd>
                        <input name="yearprice" id="form_vip_year" type="text" value="${memberlv.yearprice}"  class="s-txt" style='width:200px'>
                        <p>单位：元</p>
                    </dd>
                </dl>
                ...
                <dl class="lineD" id='dl_h5_icon'>
                    ...
                    <dd>
                        ...
                        <div>
                            ...
                            <input name="h5_icon" id="form_h5_icon" type="hidden" value="0" class="s-txt" style="width:200px;" />
                            <!-- </FORM> -->
                        </div>
                        <p>建议尺寸：40px*40px</p>
                    </dd>
