...
<div id="container" class="so_main">
    <div class="tit_tab">
        ...
        <form method="POST" action="/touxian/addXqTouxian"  name='detail_form' style="margin-top:5px">
            <div class="form2">
                ...
                <dl class="lineD" id='dl_sort'>
                    ...
                    <dd>
                        <input name="orderid" id="form_sort" type="text" value=""  class="s-txt" style='width:200px'>
                    </dd>
                </dl>
