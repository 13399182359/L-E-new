...
<div id="container" class="so_main">
    <div class="tit_tab">
        <!-- START TAB框 -->
        <ul>
            <li><a href="http://try.51eduline.com/index.php?app=classroom&mod=AdminTeacherVip&act=index&tabHash=index"  >列表</a></li><li><a href="http://try.51eduline.com/index.php?app=classroom&mod=AdminTeacherVip&act=addVip&tabHash=addVip"  >添加</a></li>
        </ul>                    <!-- END TAB框 -->
        ...
        <div id='page_config' class = "form2 list" >
            ...
            <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
                ...
                <input type="hidden" name='pageTitle' value="编辑讲师头衔-滴滴滴" />
        ...
        <!-- START CONFIG_FORM -->
        <form method="POST" action="/touxian/updXqTouxian"  name='detail_form' style="margin-top:5px">
            <input type="hidden" name='id' value="${touxian.id}" class="s-txt" />
            <input type="hidden" name='status' value="${touxian.status}" class="s-txt" />
            <div class="form2">
                <dl class="lineD" id='dl_title'>
                    <dt><font color="red"> * </font>名称：</dt>
                    <dd>
                        <input name="name" id="form_title" type="text" value="${touxian.name}"  class="s-txt" style='width:200px'>
                    </dd>
                </dl>
                <dl class="lineD" id='dl_sort'>
                    <dt><font color="red"> * </font>排序：</dt>
                    <dd>
                        <input name="orderid" id="form_sort" type="text" value="${touxian.orderid}"  class="s-txt" style='width:200px'>
                    </dd>
                </dl>
