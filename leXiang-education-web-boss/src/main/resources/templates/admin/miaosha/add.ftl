...
<div id="container" class="so_main">
    <div class="tit_tab">
        ...
        <ul>
            <li><a href="http://try.51eduline.com/index.php?app=classroom&mod=AdminSeckill&act=index&tabHash=index"  >列表</a></li><li><a href="http://try.51eduline.com/index.php?app=classroom&mod=AdminSeckill&act=addEvent&tabHash=addEvent" class="on" >添加</a></li>
        </ul>        <!-- END TAB框 -->
        ...
        <div id='page_config' class = "form2 list" >
            ...
            <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
                <input type="hidden" name='pageKey' value="classroom_AdminSeckill_addEvent" />
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr overstyle="on">
                        ...
                        <td><input type="text" name='key_name[]' value='课程分类'  class="s-txt"/></td>
                        <td><select name='key_type[]'>
                                <option value='text' >文本框:input_text</option>
                                <option value='password' >密码框:input_password</option>
                                <option value='select' >下拉框:select</option>
                        ...
                        <td><input type="text" name='key_name[]' value='班级分类'  class="s-txt"/></td>
                        <td><select name='key_type[]'>
                                <option value='text' >文本框:input_text</option>
                                <option value='password' >密码框:input_password</option>
                                <option value='select' >下拉框:select</option>
                        ...
                        <td><input type="text" name='key_name[]' value='购买人数'  class="s-txt"/></td>
                        <td><select name='key_type[]'>
                                <option value='text' selected="selected">文本框:input_text</option>
                                <option value='password' >密码框:input_password</option>
                                <option value='select' >下拉框:select</option>
        ...
        <form method="POST" action="/miaosha/addXqMiaosha" style="margin-top:5px">
            <div class="form2">
                ...
                <dl class="lineD" id='dl_course_id'>
                    <dt><font color="red"> * </font>活动课程名称：</dt>
                    <dd>
                    </dd>
                </dl>-->
                <dl class="lineD" id='dl_event_price'>
                    ...
                    <dd>
                        <input name="price" id="form_event_price" type="text" value=""  class="s-txt" style='width:200px'>
                    </dd>
                </dl>
                <dl class="lineD" id='dl_total_count'>
                    <dt>购买人数：</dt>
                    <dd>
                        <input name="count" id="form_total_count" type="text" value=""  class="s-txt" style='width:200px'>
                        <p>人数设置为0为不限量</p>
                    </dd>
                </dl>
