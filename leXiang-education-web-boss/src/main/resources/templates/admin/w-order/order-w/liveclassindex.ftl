...
<div id="container" class="so_main">
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="classroom_AdminOrder_live"  class="s-txt"/>
            <input type="hidden" name='pageTitle' value="直播课堂订单 - 交易记录" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr overstyle="on">
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='live_id'> live_id</td>
                    <td width="30%"><input type="text" name='key_name[]' value='直播ID'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" >显示</option>
                            <option value="1" selected="selected">隐藏</option>
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='live_title'> live_title</td>
                    <td width="30%"><input type="text" name='key_name[]' value='直播课名称 - 课时'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='订单状态'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='开始学习'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" >显示</option>
                            <option value="1" selected="selected">隐藏</option>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_classroom_AdminOrder_live" />
            <input type="hidden" name='pageTitle' value="直播课堂订单 - 交易记录" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
                ...
                <tr overstyle="on" >
                    ...
                    <td width="15%"><input type="hidden" name='key[]' value='live_id'> live_id</td>
                    <td width="20%"><input type="text" name='key_name[]' value='直播id' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%"><select name='key_type[]'>
                            <option value='text' selected="selected">文本框:input_text</option>
                            <option value='select' >下拉框:select</option>
                            <option value='radio' >单选框:radio</option>
    ...
    <div class="form2" id='search_form' >
        <form action="/queryOrder?leixing=2" method="post">
            ...
            <dl class="lineD" id='dl_live_id'>
                <dt>直播id：</dt>
                <dd>

                    <input name="liveclassid" id="form_live_id" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
    ...
    <div class="Toolbar_inbox">
        <!-- <div class="page right"><span>共464条</span> <a class='current'>1</a><a p='2' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=2'>2</a><a p='3' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=3'>3</a><a p='4' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=4'>4</a><a p='5' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=5'>5</a><a p='24' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=24' >..24</a><a p='2' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=2' class='next'>下一页</a></div> -->
        <a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delOrders('zy_order_live')" class="btn_a"><span>删除</span></a><a onclick="admin.realDeleteOrders('zy_order_live')" class="btn_a"><span>彻底删除</span></a>
    </div>
    <!-- END TOOLBAR -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >序号</th>				<th class="line_l"   >购买用户</th>				<th class="line_l"   >机构名称</th>				<th class="line_l"   >直播课名称 - 课时</th>				<th class="line_l"   >原价</th>				<th class="line_l"   >折扣类型</th>				<th class="line_l"   >订单价格</th>				<th class="line_l"   >订单状态</th>				<th class="line_l"   >创建时间</th>				<th class="line_l"   style="width:auto;" >操作</th>		</tr>
            <#list page.pageList as order>
            <tr overstyle="on" id="tr466">
                ...
                <td >
                    <a event-node="face_card" uid="1692" href="http://try.51eduline.com/user/index/1692.html" class="" target="_blank">${order.username}</a>
                </td>
                <td >
                    <a href='http://try.51eduline.com/index.php?app=school&mod=School&act=index&' style='color:#3b5999; ' target='_blank'>${order.orgname}</a>
                </td>
                <td >
                    <a href='http://try.51eduline.com/live/123.html' style='color:#3b5999; ' target='_blank'>${order.playname}</a> - 课时：${order.hour}
                </td>
                <td >
                ...
                <td >
                    <a href="/toeditOrderById?id=${order.id}">查看详细</a> | <a href='javascript:;' onclick='delOrderByIds(${order.id})'>彻底删除</a>
                </td>
            </tr>
            </#list>
        </table>
   ...
   <#-- <div class="Toolbar_inbox">
        <div class="page right"><span>共464条</span> <a class='current'>1</a><a p='2' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=2'>2</a><a p='3' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=3'>3</a><a p='4' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=4'>4</a><a p='5' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=5'>5</a><a p='24' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=24' >..24</a><a p='2' href='/index.php?app=classroom&mod=AdminOrder&act=live&tabHash=live&p=2' class='next'>下一页</a></div>
        <!-- 	<a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delOrders('zy_order_live')" class="btn_a"><span>删除</span></a><a onclick="admin.realDeleteOrders('zy_order_live')" class="btn_a"><span>彻底删除</span></a> &ndash;&gt;
    </div>-->
    <!-- END BOTTOMBAR -->
