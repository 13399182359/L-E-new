...
<div id="container" class="so_main">
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="classroom_AdminOrder_meetingcourse"  class="s-txt"/>
            <input type="hidden" name='pageTitle' value="线下课订单 - 交易记录" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr overstyle="on">
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='预约时间'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_classroom_AdminOrder_meetingcourse" />
            <input type="hidden" name='pageTitle' value="线下课订单 - 交易记录" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
                ...
                <tr overstyle="on" >
                    ...
                    <td width="20%"><input type="text" name='key_name[]' value='线下课程ID' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%"><select name='key_type[]'>
                            <option value='text' selected="selected">文本框:input_text</option>
                            <option value='select' >下拉框:select</option>
                            <option value='radio' >单选框:radio</option>
    ...
    <div class="form2" id='search_form' >
        <form action="/queryOrder?leixing=3" method="post">
            ...
            <dl class="lineD" id='dl_video_id'>
                ...
                <dd>
                    ...
                    <input name="lineclassid" id="form_video_id" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
            ...
            <dl class="lineD" id='dl_teacher_name'>
                ...
                <dd>
                    ...
                    <input name="teachername" id="form_teacher_name" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
    ...
    <div class="Toolbar_inbox">
        <!-- <div class="page right"><span>共25条</span> <a class='current'>1</a><a p='2' href='/index.php?app=classroom&mod=AdminOrder&act=meetingcourse&tabHash=meetingcourse&p=2'>2</a><a p='2' href='/index.php?app=classroom&mod=AdminOrder&act=meetingcourse&tabHash=meetingcourse&p=2' class='next'>下一页</a></div> -->
        <a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delOrders('zy_order_teacher')" class="btn_a"><span>删除</span></a><a onclick="admin.realDeleteOrders('zy_order_teacher')" class="btn_a"><span>彻底删除</span></a>
    </div>
    <!-- END TOOLBAR -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >序号</th>				<th class="line_l"   >购买用户</th>				<th class="line_l"   >机构名称</th>				<th class="line_l"   >线下课名称</th>				<th class="line_l"   >讲师名称</th>				<th class="line_l"   >价格</th>				<th class="line_l"   >支付状态</th>				<th class="line_l"   >学习状态</th>				<th class="line_l"   >预约时间</th>				<th class="line_l"   style="width:auto;" >操作</th>		</tr>
            <#list page.pageList as order>
            <tr overstyle="on" id="tr25">
                ...
                <td >
                    <a href='http://try.51eduline.com/lineclass/37.html' style='color:#3b5999; ' target='_blank'>${order.playname}</a>
                </td>
                <td >
                    <a href='http://try.51eduline.com/teacher/1.html' style='color:#3b5999; ' target='_blank'>${order.teachername}</a>
                </td>
                <td >
                    ${order.price}
                </td>
    ...
    <#--<div class="Toolbar_inbox">
        <div class="page right"><span>共25条</span> <a class='current'>1</a><a p='2' href='/index.php?app=classroom&mod=AdminOrder&act=meetingcourse&tabHash=meetingcourse&p=2'>2</a><a p='2' href='/index.php?app=classroom&mod=AdminOrder&act=meetingcourse&tabHash=meetingcourse&p=2' class='next'>下一页</a></div>
        <!-- 	<a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delOrders('zy_order_teacher')" class="btn_a"><span>删除</span></a><a onclick="admin.realDeleteOrders('zy_order_teacher')" class="btn_a"><span>彻底删除</span></a> &ndash;&gt;
    </div>-->
    <!-- END BOTTOMBAR -->
