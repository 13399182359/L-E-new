...
<div id="container" class="so_main">
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="classroom_AdminOrder_album"  class="s-txt"/>
            <input type="hidden" name='pageTitle' value="班级订单 - 交易记录" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr overstyle="on">
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='album_id'> album_id</td>
                    <td width="30%"><input type="text" name='key_name[]' value='班级ID'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='班级名称'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='支付时间'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_classroom_AdminOrder_album" />
            <input type="hidden" name='pageTitle' value="班级订单 - 交易记录" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
                ...
                <tr overstyle="on" >
                    ...
                    <td width="20%"><input type='text' name='key_tishi[]' value='根据订单ID查询某个专辑订单' class="s-txt"  style="width:200px"  onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" ></td>
                    ...
                    <td width="15%"><input type="hidden" name='key[]' value='album_id'> album_id</td>
    ...
    <div class="form2" id='search_form' >
        <form action="/queryOrder?leixing=1" method="post">
            ...
            <dl class="lineD" id='dl_album_id'>
                <dt>班级ID：</dt>
                <dd>

                    <input name="classid" id="form_album_id" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
    ...
    <div class="Toolbar_inbox">
        <!-- <div class="page right"><span>共14条</span></div> -->
        <a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delOrders('zy_order_album')" class="btn_a"><span>删除</span></a><a onclick="admin.realDeleteOrders('zy_order_album')" class="btn_a"><span>彻底删除</span></a>
    </div>
    <!-- END TOOLBAR -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >序号</th>				<th class="line_l"   >购买用户</th>				<th class="line_l"   >机构名称</th>				<th class="line_l"   >班级ID</th>				<th class="line_l"   >班级名称</th>				<th class="line_l"   >原价</th>				<th class="line_l"   >折扣类型</th>				<th class="line_l"   >价格</th>				<th class="line_l"   >状态</th>				<th class="line_l"   >支付时间</th>				<th class="line_l"   style="width:auto;" >操作</th>		</tr>
            <#list page.pageList as order>
            <tr overstyle="on" id="tr14">
                ...
                <td >
                    <a href='http://bb.try.51eduline.com' style='color:#3b5999; ' target='_blank'>${order.orgname}</a>
                </td>
                <td >
                    ${order.classid}
                </td>
                <td >
                    <a href='http://try.51eduline.com/index.php?app=course&mod=Album&act=view&id=30' style='color:#3b5999; ' target='_blank'>${order.playname}</a>
                </td>
                <td >
    ...
    <#--<div class="Toolbar_inbox">
        <div class="page right"><span>共14条</span></div>
        <!-- 	<a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delOrders('zy_order_album')" class="btn_a"><span>删除</span></a><a onclick="admin.realDeleteOrders('zy_order_album')" class="btn_a"><span>彻底删除</span></a> &ndash;&gt;
    </div>-->
    <!-- END BOTTOMBAR -->
