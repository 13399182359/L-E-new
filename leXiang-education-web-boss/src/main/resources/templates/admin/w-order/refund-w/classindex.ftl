...
<div id="container" class="so_main">
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="classroom_AdminApplirefund_album"  class="s-txt"/>
            <input type="hidden" name='pageTitle' value="班级订单 - 申请退款交易记录" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr overstyle="on">
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='套餐ID'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='套餐名称'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_classroom_AdminApplirefund_album" />
            <input type="hidden" name='pageTitle' value="班级订单 - 申请退款交易记录" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
    ...
    <div class="form2" id='search_form' >
        <form action="/queryRefund?leixing=1" method="post">
            ...
            <dl class="lineD" id='dl_album_id'>
                ...
                <dd>
                    ...
                    <input name="mealid" id="form_album_id" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"  style="width:30px;"  >id</th>				<th class="line_l"   >购买用户</th>				<th class="line_l"   >机构名称</th>				<th class="line_l"   >套餐ID</th>				<th class="line_l"   >套餐名称</th>				<th class="line_l"   >原价</th>				<th class="line_l"   >折扣</th>				<th class="line_l"   >折扣类型</th>				<th class="line_l"   >订单价格</th>				<th class="line_l"   >退款状态</th>				<th class="line_l"   >学习状态</th>				<th class="line_l"   >创建时间</th>				<th class="line_l"   style="width:auto;" >操作</th>		</tr>
   ...
   <#-- <div class="Toolbar_inbox">
        <div class="page right"><span>共0条</span></div>
        <!-- 	<a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delOrders('zy_order_album')" class="btn_a"><span>删除</span></a> &ndash;&gt;
    </div>-->
    <!-- END BOTTOMBAR -->
