...
<div id="container" class="so_main">
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="classroom_AdminApplirefund_teachercourse"  class="s-txt"/>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_classroom_AdminApplirefund_teachercourse" />
            <input type="hidden" name='pageTitle' value="线下课订单 - 交易记录" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
                ...
                <tr overstyle="on" >
                    ...
                    <td width="20%"><input type="text" name='key_name[]' value='线下课ID' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%"><select name='key_type[]'>
                            <option value='text' selected="selected">文本框:input_text</option>
                            <option value='select' >下拉框:select</option>
                            <option value='radio' >单选框:radio</option>
    ...
    <div class="form2" id='search_form' >
        <form action="/queryRefund?leixing=2" method="post">
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"  style="width:30px;"  >id</th>				<th class="line_l"   >用户名称</th>				<th class="line_l"   >机构名称</th>				<th class="line_l"   >线下课名称</th>				<th class="line_l"   >价格</th>				<th class="line_l"   >退款状态</th>				<th class="line_l"   >学习状态</th>				<th class="line_l"   >创建时间</th>				<th class="line_l"   style="width:auto;" >操作</th>		</tr>
            ...
            <tr overstyle="on" id="tr5">
                ...
                <td >
                    <a href='http://aa.try.51eduline.com' style='color:blue; ' target='_blank'>${order.playname}</a>
                </td>
                <td >
    ...
    <#--<div class="Toolbar_inbox">
        <div class="page right"><span>共2条</span></div>
        <!-- 	<a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delOrders('zy_order_teacher')" class="btn_a"><span>删除</span></a> &ndash;&gt;
    </div>-->
