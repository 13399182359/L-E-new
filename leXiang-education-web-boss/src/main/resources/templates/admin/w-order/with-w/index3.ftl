...
<div id="container" class="so_main">
    ...
    <div class="form2" id='search_form' >
        <form action="/queryFin?withdrawstatus=3" method="post">
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >ID</th>				<th class="line_l"   >用户</th>				<th class="line_l"   >提现金额</th>				<th class="line_l"   >提现类型</th>				<th class="line_l"   >提现人</th>				<th class="line_l"   >提现账户</th>				<th class="line_l"   >申请时间</th>				<th class="line_l"   >状态</th>				<th class="line_l"   style="width:auto;" >操作</th> <th class="line_l"   >处理时间</th>	<th class="line_l"   >失败原因</th>	</tr>
            ...
            <tr>
                <td style="width:30px;">
                    <input type="checkbox" name="checkbox" onclick="admin.checkon(this)" value=${w.widthdrawid}>
                        ...
                        <td>${w.wcreatdate}</td>
                        <td>
                            <#if w.withdrawstatus=3>处理失败<#else>处理失败</#if>
                        </td>
                        <td ><a href="#" onclick="delWidthById(${w.widthdrawid})">删除</a></td>
                        <td>${w.wdisposedate}</td>
                        <td>${w.wlosers}</td>
            </tr>
                </#list>
    ...
    delBankByIds = function () {
        ...
        if ( ids!= null && ids!="") {
            $.post("/delWithById",{ids:ids},function (data) {
                alert(data.message)
                location.href="/queryFin?withdrawstatus=3";
            })
        }else {
            alert("请选择要删除的数据！！")
        }
