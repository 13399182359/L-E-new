...
<div id="container" class="so_main">
    ...
    <div class="form2" id='search_form' >
        <form action="/queryFin?withdrawstatus=2" method="post">
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >ID</th>				<th class="line_l"   >用户</th>				<th class="line_l"   >提现金额</th>				<th class="line_l"   >提现类型</th>				<th class="line_l"   >提现人</th>				<th class="line_l"   >提现账户</th>				<th class="line_l"   >申请时间</th>				<th class="line_l"   >状态</th>				<th class="line_l"   style="width:auto;" >操作</th> <th class="line_l"   >处理时间</th>		</tr>
            ...
            <#list page.pageList as w>
                <tr>
                    ...
                    <td>${w.wcreatdate}</td>
                    <td>
                        <#if w.withdrawstatus=2>处理成功<#else>处理成功</#if>
                    </td>
    ...
    delBankByIds = function () {
        ...
        if ( ids!= null && ids!="") {
            $.post("/delWithById",{ids:ids},function (data) {
                alert(data.message)
                location.href="/queryFin?withdrawstatus=2";
            })
        }else {
            alert("请选择要删除的数据！！")
        }
