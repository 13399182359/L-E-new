    ...
    <tr>
        <td colspan="3">
            <div class="header"><!-- 头部 begin -->
                ...
                <div class="nav_sub">
                    您好,15035069796&nbsp; | <a target="_blank" href="/">返回前台</a> | <a href="javascript:void(0);" onClick="refresh();">刷新</a> | <a href="http://try.51eduline.com/index.php?app=admin&mod=Public&act=logout">退出</a><br/>
                    <div id="TopTime"></div>
                </div>
                <div class="main_nav">
                ...
                <ul class="MenuList" id="root_content" style="display:none;">
                    ...
                    <li class="treemenu">
                        ...
                        <ul id="tree_17" class="submenu">
                            <!-- 第三级菜单 -->
                            <li><a id="menu_18" href="javascript:void(0)" onClick="switch_sub_menu('18', '../findInformation');" class="submenuA" hidefocus="true" style="outline:none;">资讯管理</a></li>
                            <li><a id="menu_19" href="javascript:void(0)" onClick="switch_sub_menu('19', '../page/findPage');" class="submenuA" hidefocus="true" style="outline:none;">单页管理</a></li>
                            <li><a id="menu_20" href="javascript:void(0)" onClick="switch_sub_menu('20', '../message/findXqMessage');" class="submenuA" hidefocus="true" style="outline:none;">私信管理</a></li>
                            <li><a id="menu_21" href="javascript:void(0)" onClick="switch_sub_menu('21', '../feedback/findXqFeedback');" class="submenuA" hidefocus="true" style="outline:none;">反馈管理</a></li>
                            <li><a id="menu_22" href="javascript:void(0)" onClick="switch_sub_menu('22', '../news/findXqNews');" class="submenuA" hidefocus="true" style="outline:none;">系统消息管理</a></li>
                            <li><a id="menu_23" href="javascript:void(0)" onClick="switch_sub_menu('23', '../liuyan/findXqLiuyan');" class="submenuA" hidefocus="true" style="outline:none;">留言板管理</a></li>
                        </ul>
                    </li>
                    <li class="treemenu">
                        ...
                        <ul id="tree_24" class="submenu">
                            <!-- 第三级菜单 -->
                            <li><a id="menu_25" href="javascript:void(0)" onClick="switch_sub_menu('25', '../dazhe/findXqDazhe');" class="submenuA" hidefocus="true" style="outline:none;">限时打折</a></li>
                            <li><a id="menu_26" href="javascript:void(0)" onClick="switch_sub_menu('26', '../miaosha/findXqMiaosha');" class="submenuA" hidefocus="true" style="outline:none;">秒杀抢购</a></li>
                        </ul>
                    </li>
                    <li class="treemenu">
                        ...
                        <ul id="tree_27" class="submenu">
                            <!-- 第三级菜单 -->
                            <li><a id="menu_28" href="javascript:void(0)" onClick="switch_sub_menu('28', '../huiyuandengji/findXqHuiyuandengji');" class="submenuA" hidefocus="true" style="outline:none;">会员等级</a></li>
                            <li><a id="menu_29" href="javascript:void(0)" onClick="switch_sub_menu('29', '../touxian/findXqTouxian');" class="submenuA" hidefocus="true" style="outline:none;">讲师头衔</a></li>
                        </ul>
                    </li>
                    <li class="treemenu">
                        ...
                        <ul id="tree_30" class="submenu">
                            <!-- 第三级菜单 -->
                            <li><a id="menu_31" href="javascript:void(0)" onClick="switch_sub_menu('31', '../integrals/findXqIntegrals');" class="submenuA" hidefocus="true" style="outline:none;">积分规则配置</a></li>
