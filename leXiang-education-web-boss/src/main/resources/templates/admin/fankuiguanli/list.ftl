...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            <li><a href="http://try.51eduline.com/index.php?app=admin&mod=Suggest&act=index&tabHash=index" class="on">列表</a></li>
            <!--  -->
        </ul>
    </div>
    <!-- END TAB框 -->
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="admin_Suggest_index"  class="s-txt"/>
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr overstyle="on">
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='反馈内容'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='contact_way'> contact_way</td>
                    <td width="30%"><input type="text" name='key_name[]' value='联系方式'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='反馈时间'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_admin_Suggest_index" />
            <input type="hidden" name='pageTitle' value="" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
                ...
                <tr overstyle="on" >
                    ...
                    <td width="20%"><input type="text" name='key_name[]' value='反馈内容' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%"><select name='key_type[]'>
                            <option value='text' selected="selected">文本框:input_text</option>
                            <option value='select' >下拉框:select</option>
                            <option value='radio' >单选框:radio</option>
    ...
    <div class="form2" id='search_form' >
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Suggest&act=index&dosearch=1" method="post">
            ...
            <dl class="lineD" id='dl_content'>
                <dt>反馈内容：</dt>
                <dd>
                    <input name="feedbackcontent" id="form_content" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
                </dd>
            </dl>
            <div class="page_btm">
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="delFeedbackXq()" class="btn_a"><span>删除</span></a>
    </div>
    <!-- END TOOLBAR -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <th style="width:30px;"><input type="checkbox" id="checkbox_handle" onclick="admin.checkAll(this)" value="0"></th>
            ...
            <#list list.list as feedback>
                <tr overstyle="on" id="tr83">
                    <td><input type="checkbox" value="${feedback.id}" name="checkbox"></td>
                    <td >${feedback.id}</td>
                    <td >${feedback.username?default(" ")}</td>
                    <td >${feedback.feedbackcontent?default(" ")}</td>
                    <td >${feedback.phone?default(" ")}</td>
                    <td >${feedback.time?date}</td>
                    <td ><a href='/feedback/delFeedbackXq?id=${feedback.id}'>删除</a></td>
                </tr>
            </#list>
        </table>
    </div>
    ...
    <div class="Toolbar_inbox">
        <div class="page right"><span>共0条</span></div>
        <!-- 	<a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delSuggest()" class="btn_a"><span>删除</span></a> -->
    </div>
    <!-- END BOTTOMBAR -->
</div>
<script>
...
<script type="text/javascript">
    function delFeedbackXq() {
        ...
        ids= ids.substr(1);
        if ( ids!= null && ids!="") {
            $.post("/feedback/delFeedbackXqs",{ids:ids},function (data) {
                alert(data.message)
                location.href="/feedback/findXqFeedback";
            })
        }else {
            alert("请选择要删除的数据！！")
        }
