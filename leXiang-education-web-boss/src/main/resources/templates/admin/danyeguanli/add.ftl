...
<div id="container" class="so_main">
    <div class="tit_tab">
        <!-- START TAB框 -->
        <ul>
            <li><a href="/page/findPage" class="on">列表</a></li><li><a href="/page/toadd" >添加</a></li>
        </ul>                    <!-- END TAB框 -->
        ...
        <div id='page_config' class = "form2 list" >
            ...
            <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
                <input type="hidden" name='pageKey' value="admin_Single_add" />
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr overstyle="on">
                        ...
                        <td><input type='text' name='key_default[]' value='' class="s-txt"></td>
                        <td><input type='text' name='key_tishi[]' value='请用英文或数字' class="s-txt"></td>
                        <td><input type='text' name='key_javascript[]' value='' class="s-txt"></td>
                    </tr>                        <tr overstyle="on">
        ...
        <form method="POST" action="/page/addxqpage">
            <div class="form2">
                <dl class="lineD" id='dl_title'>
                    <dt><font color="red"> * </font>标题：</dt>
                    <dd>
                        <input name="title" id="form_title" type="text"  class="s-txt" style='width:200px'>
                    </dd>
                </dl>
                <dl class="lineD" id='dl_key'>
                    <dt><font color="red"> * </font>唯一标识：</dt>
                    <dd>
                        <input name="identify" id="form_key" type="text"  class="s-txt" style='width:200px'>
                        <p>请用英文或数字</p>
                    </dd>
                </dl>
