...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            <li><a href="http://try.51eduline.com/index.php?app=course&mod=AdminQuestion&act=index&tabHash=index" class="on">列表</a></li>
            <!-- 提问管理 -->
        </ul>
    </div>
    <!-- END TAB框 -->
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="course_AdminQuestion_index"  class="s-txt"/>
            <input type="hidden" name='pageTitle' value="提问管理" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr overstyle="on">
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='qst_title'> qst_title</td>
                    <td width="30%"><input type="text" name='key_name[]' value='问题标题'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='qst_description'> qst_description</td>
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='提问类型'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='qst_help_count'> qst_help_count</td>
                    <td width="30%"><input type="text" name='key_name[]' value='同问数量'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='qst_comment_count'> qst_comment_count</td>
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='qst_source'> qst_source</td>
                    <td width="30%"><input type="text" name='key_name[]' value='问题来源'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_course_AdminQuestion_index" />
            <input type="hidden" name='pageTitle' value="提问管理" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
                ...
                <tr overstyle="on" >
                    ...
                    <td width="20%"><input type="text" name='key_name[]' value='问题ID' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    ...
                    <td width="20%"><input type="text" name='key_name[]' value='提问类型' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%"><select name='key_type[]'>
                            <option value='text' >文本框:input_text</option>
                            <option value='select' >下拉框:select</option>
                            <option value='radio' >单选框:radio</option>
                    ...
                    <td width="15%"><input type="hidden" name='key[]' value='qst_description'> qst_description</td>
    ...
    <div class="form2" id='search_form' >
        <form action="/quizCyq/findQuiz" method="post">
            <input name="type" id="form_type" type="hidden" value=""  class='s-txt'>
            <dl class="lineD" id='dl_qst_description'>
                <dt>问题描述：</dt>
                <dd>
                    <input name="description" id="form_qst_description" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
                </dd>
            </dl>
            <div class="page_btm">
    ...
    <div class="Toolbar_inbox">
        <!-- <div class="page right"><span>共76条</span> <a class='current'>1</a><a p='2' href='/index.php?app=course&mod=AdminQuestion&act=index&p=2'>2</a><a p='3' href='/index.php?app=course&mod=AdminQuestion&act=index&p=3'>3</a><a p='4' href='/index.php?app=course&mod=AdminQuestion&act=index&p=4'>4</a><a p='2' href='/index.php?app=course&mod=AdminQuestion&act=index&p=2' class='next'>下一页</a></div> -->
        <a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="deleteQuizIds()" class="btn_a"><span>删除</span></a>
    </div>
    <!-- END TOOLBAR -->
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <#list quiz1.list as list>
                <tr>
                    ...
                    <td >
                        <a href="/quizCyq/deleteQuiz?id=${list.id}">删除</a> |
                        <a href="http://try.51eduline.com/index.php?app=course&mod=AdminVideo&act=answerVideo&oid=143&id=107&tabHash=answerVideo">查看回答</a>
                    </td>
                </tr>
            </#list>
        </table>
    ...
    <#--<div class="Toolbar_inbox">
        <div class="page right"><span>共76条</span> <a class='current'>1</a><a p='2' href='/index.php?app=course&mod=AdminQuestion&act=index&p=2'>2</a><a p='3' href='/index.php?app=course&mod=AdminQuestion&act=index&p=3'>3</a><a p='4' href='/index.php?app=course&mod=AdminQuestion&act=index&p=4'>4</a><a p='2' href='/index.php?app=course&mod=AdminQuestion&act=index&p=2' class='next'>下一页</a></div>
        <!-- 	<a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.mzQuestionEdit('delquestion')" class="btn_a"><span>删除</span></a> &ndash;&gt;
    </div>-->
    <!-- END BOTTOMBAR -->
</div>
<script>
...
<script type="text/javascript">
    function deleteQuizIds(){
        ...
        ids= ids.substr(1);
        if ( ids!= null && ids!="") {
            $.post("/quizCyq/deleteQuizIds",{ids:ids},function () {
