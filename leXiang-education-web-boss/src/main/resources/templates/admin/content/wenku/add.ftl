...
<div id="container" class="so_main">
    <div class="tit_tab">
        <!-- START TAB框 -->
        <ul>
            <li><a href="http://try.51eduline.com/index.php?app=classroom&mod=AdminLibrary&act=index&tabHash=index"  >列表</a></li><li><a href="http://try.51eduline.com/index.php?app=classroom&mod=AdminLibrary&act=addLibrary&tabHash=addLibrary" class="on" >添加</a></li>
        </ul>                    <!-- END TAB框 -->
        ...
        <div id='page_config' class = "form2 list" >
            ...
            <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
                <input type="hidden" name='pageKey' value="classroom_AdminLibrary_addLibrary" />
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr overstyle="on">
                        ...
                        <td><input type='text' name='key_default[]' value='' class="s-txt"></td>
                        <td><input type='text' name='key_tishi[]' value='app端仅支持pdf打开' class="s-txt"></td>
                        <td><input type='text' name='key_javascript[]' value='' class="s-txt"></td>
                    </tr>                </table>
                <div class="page_btm">
        ...
        <!-- START CONFIG_FORM -->
        <form method="POST" action="/libraryCyq/insertLibrary" name='detail_form' style="margin-top:5px">
            <input type="hidden" name='systemdata_list' value="classroom_AdminLibrary"  class="s-txt"/>
            <input type="hidden" name='systemdata_key' value="addLibrary"  class="s-txt"/>
            <input type="hidden" name='pageTitle' value="添加" class="s-txt" />
            <div class="form2">
                <dl class="lineD" id='dl_title'>
                    <dt><font color="red"> * </font>文库标题：</dt>
                    <dd>
                        <input name="title" type="text"  class="s-txt" style='width:200px'>
                    </dd>
                </dl>
                ...
                <dl class="lineD" id='dl_is_re'>
                    ...
                    <dd>
                        <label><input type="radio" name="recommended" value='0'  checked="checked"  >不推荐 </label>
