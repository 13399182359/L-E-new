...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            <li><a href="http://try.51eduline.com/index.php?app=admin&mod=SystemMessage&act=index&tabHash=index" class="on">列表</a></li>
            <!-- 系统消息列表 -->
        </ul>
    </div>
    <!-- END TAB框 -->
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="admin_SystemMessage_index"  class="s-txt"/>
            <input type="hidden" name='pageTitle' value="系统消息列表" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr overstyle="on">
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='消息标题'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='appname'> appname</td>
                    <td width="30%"><input type="text" name='key_name[]' value=''  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='body'> body</td>
                    <td width="30%"><input type="text" name='key_name[]' value='消息内容'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="20%"> <input type="hidden" name='key[]' value='is_read'> is_read</td>
                    <td width="30%"><input type="text" name='key_name[]' value='是否阅读'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_admin_SystemMessage_index" />
            <input type="hidden" name='pageTitle' value="系统消息列表" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
                ...
                <tr overstyle="on" >
                    ...
                    <td width="20%"><input type="text" name='key_name[]' value='消息标题' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%"><select name='key_type[]'>
                            <option value='text' selected="selected">文本框:input_text</option>
                            <option value='select' >下拉框:select</option>
                            <option value='radio' >单选框:radio</option>
                    ...
                    <td width="15%"><input type="hidden" name='key[]' value='appname'> appname</td>
                    <td width="20%"><input type="text" name='key_name[]' value='' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%"><select name='key_type[]'>
                            <option value='text' >文本框:input_text</option>
                            <option value='select' >下拉框:select</option>
                    ...
                    <td width="15%"><input type="hidden" name='key[]' value='body'> body</td>
                    <td width="20%"><input type="text" name='key_name[]' value='消息内容' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%"><select name='key_type[]'>
                            <option value='text' selected="selected">文本框:input_text</option>
                            <option value='select' >下拉框:select</option>
                            <option value='radio' >单选框:radio</option>
                    ...
                    <td width="15%"><input type="hidden" name='key[]' value='is_read'> is_read</td>
                    <td width="20%"><input type="text" name='key_name[]' value='是否阅读' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%"><select name='key_type[]'>
                            <option value='text' >文本框:input_text</option>
                            <option value='select' >下拉框:select</option>
    ...
    <div class="form2" id='search_form' >
        <form action="http://try.51eduline.com/index.php?app=admin&mod=SystemMessage&act=index&dosearch=1" method="post">
            ...
            <input name="appname" id="form_appname" type="hidden" value=""  class='s-txt'>


            <dl class="lineD" id='dl_body'>
                <dt>消息内容：</dt>
                <dd>

                    <input name="body" id="form_body" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
            ...
            <dl class="lineD" id='dl_is_read'>
                ...
                <dd>
                    ...
                    <label><input type="radio" name="is_read" value='0'  checked="checked"  >全部 </label> 										<label><input type="radio" name="is_read" value='1'   >未读 </label> 										<label><input type="radio" name="is_read" value='2'   >已读 </label>
    ...
    <div class="Toolbar_inbox">
        <!-- <div class="page right"><span>共3316条</span> <a class='current'>1</a><a p='2' href='/index.php?app=admin&mod=SystemMessage&act=index&p=2'>2</a><a p='3' href='/index.php?app=admin&mod=SystemMessage&act=index&p=3'>3</a><a p='4' href='/index.php?app=admin&mod=SystemMessage&act=index&p=4'>4</a><a p='5' href='/index.php?app=admin&mod=SystemMessage&act=index&p=5'>5</a><a p='166' href='/index.php?app=admin&mod=SystemMessage&act=index&p=166' >..166</a><a p='2' href='/index.php?app=admin&mod=SystemMessage&act=index&p=2' class='next'>下一页</a></div> -->
        <a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="delNewsXqs()" class="btn_a"><span>删除</span></a>
    </div>
    <!-- END TOOLBAR -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >消息标题</th>
                <th class="line_l"   >消息内容</th>
                <th class="line_l"   >创建时间</th>
                <th class="line_l"   >是否阅读</th>
                <th class="line_l"   style="width:auto;" >操作</th>
            </tr>
            <#list list.list as news>
                <tr overstyle="on" id="tr83">
                    <td><input type="checkbox" value="${news.id}" name="checkbox"></td>
                    <td >${news.id}</td>
                    <td >${news.username?default(" ")}</td>
                    <td >${news.title?default(" ")}</td>
                    <td >${news.content?default(" ")}</td>
                    <td >${news.time?date}</td>
                    <td ><#if news.isread=1>
                            已阅读
                        <#else >
                            未阅读
                    ...
                    <td ><a href='/news/delNewsXq?id=${news.id}'>删除</a></td>
                </tr>
            </#list>
        </table>
    </div>
    ...
    <div class="Toolbar_inbox">
        <#--<div class="page right"><span>共3316条</span> <a class='current'>1</a><a p='2' href='/index.php?app=admin&mod=SystemMessage&act=index&p=2'>2</a><a p='3' href='/index.php?app=admin&mod=SystemMessage&act=index&p=3'>3</a><a p='4' href='/index.php?app=admin&mod=SystemMessage&act=index&p=4'>4</a><a p='5' href='/index.php?app=admin&mod=SystemMessage&act=index&p=5'>5</a><a p='166' href='/index.php?app=admin&mod=SystemMessage&act=index&p=166' >..166</a><a p='2' href='/index.php?app=admin&mod=SystemMessage&act=index&p=2' class='next'>下一页</a></div>-->
        <!-- 	<a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.SystemMessage('','delmessage','删除','系统消息')" class="btn_a"><span>删除</span></a> -->
    </div>
    <!-- END BOTTOMBAR -->
</div>
<script>
