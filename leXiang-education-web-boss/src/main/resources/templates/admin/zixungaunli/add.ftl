...
<div id="container" class="so_main">
    <div class="tit_tab">
        <!-- START TAB框 -->
        <ul>
            <li><a href="../findInformation"  >列表</a></li><li><a href="http://try.51eduline.com/index.php?app=news&mod=AdminTopic&act=newZixun&tabHash=newZixun" class="on" >添加资讯</a></li>
        </ul>                    <!-- END TAB框 -->
        ...
        <div id='page_config' class = "form2 list" >
            ...
            <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
                <input type="hidden" name='pageKey' value="news_AdminTopic_newZixun" />
                <input type="hidden" name='pageTitle' value="添加资讯" />
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr overstyle="on">
                        ...
                        <td><input type="text" name='key_name[]' value='摘要'  class="s-txt"/></td>
                        <td><select name='key_type[]'>
                                <option value='text' >文本框:input_text</option>
                                <option value='password' >密码框:input_password</option>
                                <option value='select' >下拉框:select</option>
                        ...
                        <td> <input type="hidden" name='key[]' value='recount'> recount</td>
        ...
        <form method="POST" action="../addInformation" name='detail_form' style="margin-top:5px">
            <div class="form2">
                <dl class="lineD" id='dl_title'>
                    <dt>标题：</dt>
                    <dd>
                        <input name="title" id="form_title" type="text" value=""  class="s-txt" style='width:200px'>
                    </dd>
                </dl>
                ...
                <dl class="lineD" id='dl_text'>
                    ...
                    <dd>
                        <!--发布样式 begi-->
                        <script id="text" name="content" type="text/plain" style="width:99%;height:200px; margin-bottom:10px;"></script>
                ...
                <dl class="lineD" id='dl_image'>
                    ...
                    <dd>
                        ...
                        <div>
                            ...
                            <input name="image" id="form_image" type="hidden" value="" class="s-txt" style="width:200px;" />
                            <!-- </FORM> -->
                        </div>
                ...
                <dl class="lineD" id='dl_re'>
                    <dt>是否推荐：</dt>
                    <dd>
                        <label><input type="radio" name="re" value='1'   >是 </label>
                        <label><input type="radio" name="re" value='0'  checked="checked"  >否 </label>
                        <br />
                    </dd>
                </dl>
                <dl class="lineD" id='dl_re_sort'>
                    <dt>推荐排序：</dt>
                    <dd>
                        <input name="orderid" id="form_re_sort" type="text" value=""  class="s-txt" style='width:200px'>
                        <p>0-999，值越小越靠前</p>
                    </dd>
                </dl>
                <dl class="lineD" id='dl_from'>
                    <dt>来源：</dt>
                    <dd>
                        <input name="source" id="form_from" type="text" value=""  class="s-txt" style='width:200px'>
                    </dd>
                </dl>
                <dl class="lineD" id='dl_recount'>
                    <dt>浏览量：</dt>
                    <dd>
                        <input name="count" id="form_recount" type="text" value=""  class="s-txt" style='width:200px'>
                    </dd>
                </dl>
                <div class="page_btm" >
