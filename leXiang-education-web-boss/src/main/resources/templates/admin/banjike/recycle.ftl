...
<div id="container" class="so_main">
    ...
    <div class="tit_tab">
        <ul>
            <li><a href="/classCyq/findClass" >列表</a></li><li><a href="/classCyq/toAdd">添加</a></li><li><a href="/classCyq/findStatus" class="on">回收站</a></li><li><a href="http://try.51eduline.com/index.php?app=course&mod=AdminAlbum&act=export&tabHash=export" >导出</a></li>
            <!-- 回收站 -->
        </ul>
    </div>
    <!-- END TAB框 -->
    ...
    <div id='page_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            <input type="hidden" name='pageKey' value="course_AdminAlbum_recycle"  class="s-txt"/>
    ...
    <div id='search_config' class = "form2 list" >
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            <input type="hidden" name='searchPageKey' value="S_course_AdminAlbum_recycle" />
            <input type="hidden" name='pageTitle' value="回收站" />
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <th>字段</th>
    ...
    <div class="form2" id='search_form' >
        <form action="http://try.51eduline.com/index.php?app=course&mod=AdminAlbum&act=recycle&dosearch=1" method="post">
            <div class="page_btm">
    ...
    <div class="Toolbar_inbox">
        <!-- <div class="page right"><span>共24条</span> <a class='current'>1</a><a p='2' href='/index.php?app=course&mod=AdminAlbum&act=recycle&tabHash=recycle&p=2'>2</a><a p='2' href='/index.php?app=course&mod=AdminAlbum&act=recycle&tabHash=recycle&p=2' class='next'>下一页</a></div> -->
        <a onclick="admin.delAlbumAll('delAlbums',3)" class="btn_a"><span>彻底删除</span></a>
    </div>
    <!-- END TOOLBAR -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <#list status.list as slist>
                <tr>
                    <td>
                        <input type="checkbox" name="checkbox" value="${slist.id}">
                    </td>
                    <td>${slist.id}</td>
                    <td>${slist.name}</td>
                    <td>${slist.userid?default(" ")}</td>
                    <td>${slist.createTime?date}</td>
                    <td >
                        <a href="http://try.51eduline.com/index.php?app=course&mod=AdminAlbum&act=reviewAlbum&tabHash=reviewAlbum&id=32">评价</a> |
                        <a href="javascript:admin.disableMount(32,'Album')">禁止分销</a> |
                        <a href="/classCyq/queryById?id=${slist.id}">编辑</a> |
                        <a href="/classCyq/updateStatus?id=${slist.id}">恢复</a>  |
                        <a href="/classCyq/delete?id=${slist.id}">删除</a>
                    </td>
                </tr>
            </#list>
        </table>
    ...
    <#--<div class="Toolbar_inbox">
        <div class="page right"><span>共24条</span> <a class='current'>1</a><a p='2' href='/index.php?app=course&mod=AdminAlbum&act=recycle&tabHash=recycle&p=2'>2</a><a p='2' href='/index.php?app=course&mod=AdminAlbum&act=recycle&tabHash=recycle&p=2' class='next'>下一页</a></div>
        <!-- 	<a onclick="admin.delAlbumAll('delAlbums',3)" class="btn_a"><span>彻底删除</span></a> &ndash;&gt;
    </div>-->
    <!-- END BOTTOMBAR -->
</div>
<script>
