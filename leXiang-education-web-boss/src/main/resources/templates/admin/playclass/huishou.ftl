...
<div id="container" class="so_main">
    ...
    <div class="form2" id='search_form' >
        ...
        <form action="/findchecked" method="post">
            ...
            <dl class="lineD" id='dl_video_title'>
                <dt>课程名称：</dt>
                <dd>
                    <input name="playname" id="form_video_title" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
                </dd>
            </dl>
            <dl class="lineD" id='dl_uid'>
                <dt>上传用户UID：</dt>
                <dd>
                    <input name="userid" id="form_uid" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
                </dd>
            </dl>
            <dl class="lineD" id='dl_teacher_id'>
                <dt>教师id：</dt>
                <dd>
                    <input name="teacherid" id="teacherid" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
                </dd>
            </dl>
            <dl class="lineD" id='dl_is_charge'>
                <dt>是否免费：</dt>
                <dd>
                    <label><input type="radio" name="isfree" value=''  checked="checked"  >不限 </label> 										<label><input type="radio" name="is_charge" value='1'   >否 </label> 										<label><input type="radio" name="is_charge" value='2'   >是 </label>
                </dd>
            </dl>
            <dl class="lineD" id='dl_is_best'>
                <dt>是否精选：</dt>
                <dd>
                    <label><input type="radio" name="ischoiceness" value=''  checked="checked"  >不限 </label> 										<label><input type="radio" name="is_best" value='1'   >否 </label> 										<label><input type="radio" name="is_best" value='2'   >是 </label>
                </dd>
            </dl>
            ...
            <dl class="lineD" id='dl_listingtime'>
                <dt>上架时间：</dt>
                <dd>
                    <input name="uponedate" type="text" class="s-txt" id="from_listingtime_0" value='' onfocus="core.rcalendar(this,'full');" readonly="readonly" style="width:200px;"/>					 — 										<input name="listingtime[]" type="text" class="s-txt" id="from_listingtime_1" value='' onfocus="core.rcalendar(this,'full');" readonly="readonly" style="width:200px;"/>
                </dd>
            </dl>
            <dl class="lineD" id='dl_uctime'>
                <dt>下架时间：</dt>
                <dd>
                    <input name="downdate" type="text" class="s-txt" id="from_uctime_0" value='' onfocus="core.rcalendar(this,'full');" readonly="readonly" style="width:200px;"/>					 — 										<input name="uctime[]" type="text" class="s-txt" id="from_uctime_1" value='' onfocus="core.rcalendar(this,'full');" readonly="readonly" style="width:200px;"/>
                </dd>
            </dl>
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="del()" class="btn_a"><span>彻底删除</span></a>
    </div>
    <!-- END TOOLBAR -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <th class="line_l"   >编号</th>				<th class="line_l"   >课程名称</th>				<th class="line_l"   >创建者</th>				<th class="line_l"   >是否审核</th>				<th class="line_l"   >创建时间</th>				<th class="line_l"   style="width:auto;" >操作</th>		</tr>
            <#list pageResult.pageList as zixun>
                <tr overstyle="on" id="tr55">
                    ...
                    <td >
                        <#if zixun.status=1>
                            <a href="">重新审核</a> | <a href="/delPlayClassByIds1?ids=${zixun.id}">彻底删除</a>
                        <#else>
                            <a href="">课时管理</a> |
                            <a href="">学习记录</a> |
                            <a href="">提问</a> |
                            ...
                            <a href="">编辑</a> |
                            <a href="">赠送</a> |
                            <#if zixun.ismarketing=1>
                                <a href="/startdistribution2?ids=${zixun.id}">允许分销</a> |
                            <#else>
                                <a href="/stopdistribution2?ids=${zixun.id}">禁止分销</a> |
                            </#if>
                            <a href="/startclass?id=${zixun.id}">启用</a> |
                            <#if zixun.isputaway=1>
                                <a href="/putaway1?id=${zixun.id}">立即上架</a>
                            <#else>
                                <a href="/soldout1?id=${zixun.id}">立即下架</a>
                            </#if>
                        </#if>
                    </td>
                </tr>
        ...
        <div class="page right">
            <#if pageResult.totalCount !=0>
                ...
                <#if pageResult.current != 1>
                   /findrecycle?pageNum=${pageResult.current-1}
                <#else>
                    #
                </#if>
                ">上一页</a>
                ...
                <#if pageResult.end lte 5>
                    <#list start..pageResult.end as p>
                        <a class="<#if pageResult.current == p>current</#if>" href="/findrecycle?pageNum=${p}">${p}</a>
                    </#list>
                <#else>
...
//表格样式
    ...
    function del(){
        ...
        if (ids=="") {
            alert("请选择要删除的数据！");
        }else if(confirm("您确定要删除这个信息吗？")){
            $.post("/delPlayClassByIds",{ids:ids},function (data) {
                alert("操作成功！")
