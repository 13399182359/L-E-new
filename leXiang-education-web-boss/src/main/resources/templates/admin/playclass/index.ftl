...
<div id="container" class="so_main">
    ...
    <div class="form2" id='search_form' >
        <form action="http://try.51eduline.com/index.php?app=course&mod=AdminVideo&act=index&tabHash=index&dosearch=1" method="post">
            ...
            <dl class="lineD" id='dl_video_title'>
                <dt>课程名称：</dt>
                <dd>
                    <input name="video_title" id="form_video_title" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
                </dd>
            </dl>
            ...
            <dl class="lineD" id='dl_teacher_id'>
                <dt>教师id：</dt>
                <dd>
                    <input name="teacher_id" id="form_teacher_id" type="text" value=""  class='s-txt' style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" >
                </dd>
            </dl>
            <dl class="lineD" id='dl_is_charge'>
                <dt>是否免费：</dt>
                <dd>
                    <label><input type="radio" name="is_charge" value='0'  checked="checked"  >不限 </label> 										<label><input type="radio" name="is_charge" value='1'   >否 </label> 										<label><input type="radio" name="is_charge" value='2'   >是 </label>
                </dd>
            </dl>
            <dl class="lineD" id='dl_is_best'>
                <dt>是否精选：</dt>
                <dd>
                    <label><input type="radio" name="is_best" value='0'  checked="checked"  >不限 </label> 										<label><input type="radio" name="is_best" value='1'   >否 </label> 										<label><input type="radio" name="is_best" value='2'   >是 </label>
                </dd>
            </dl>
            <input name="is_best_like" id="form_is_best_like" type="hidden" value=""  class='s-txt'>
            <dl class="lineD" id='dl_listingtime'>
                <dt>上架时间：</dt>
                <dd>
                    <input name="listingtime[]" type="text" class="s-txt" id="from_listingtime_0" value='' onfocus="core.rcalendar(this,'full');" readonly="readonly" style="width:200px;"/>					 — 										<input name="listingtime[]" type="text" class="s-txt" id="from_listingtime_1" value='' onfocus="core.rcalendar(this,'full');" readonly="readonly" style="width:200px;"/>
                </dd>
            </dl>
            <dl class="lineD" id='dl_uctime'>
                <dt>下架时间：</dt>
                <dd>
                    <input name="uctime[]" type="text" class="s-txt" id="from_uctime_0" value='' onfocus="core.rcalendar(this,'full');" readonly="readonly" style="width:200px;"/>					 — 										<input name="uctime[]" type="text" class="s-txt" id="from_uctime_1" value='' onfocus="core.rcalendar(this,'full');" readonly="readonly" style="width:200px;"/>
                </dd>
            </dl>
            <input name="quanzhong" id="form_quanzhong" type="hidden" value=""  class='s-txt'>
            <div class="page_btm">
    ...
    <div class="Toolbar_inbox">
        ...
        <a onclick="admin.fold('search_form')" class="btn_a"><span>搜索</span></a><a onclick="admin.delVideoAll('delVideoAll')" class="btn_a"><span>禁用</span></a><a onclick="admin.enableMount(0,'Video')" class="btn_a"><span>允许分销</span></a><a onclick="admin.disableMount(0,'Video')" class="btn_a"><span>禁止分销</span></a>
    </div>
    <!-- END TOOLBAR -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <th class="line_l"   >编号</th>				<th class="line_l"   >课程名称</th>				<th class="line_l"   >课程封面</th>				<th class="line_l"   >市场价</th>				<th class="line_l"   >销售价</th>				<th class="line_l"   >上传用户</th>				<th class="line_l"   >教师名称</th>				<th class="line_l"   >课程评分</th>				<th class="line_l"   >学习人数</th>				<th class="line_l"   >学习人数（营销）</th>				<th class="line_l"   >是否免费</th>				<th class="line_l"   >是否精选</th>				<th class="line_l"   >下架时间</th>				<th class="line_l"   style="width:auto;" >操作</th>		</tr>
            <#list list as zixun>
                <tr overstyle="on" id="tr55">
                    ...
                    <td >
                        ${zixun.marketingcount}
                    </td>
                    <td >
                        <#if zixun.isfree=1>
                            <font size="" color="red">否</font>
                        <#else>
                            是
                        </#if>
                    </td>
                    <td >
                        <#if zixun.ischoiceness=1>
                            <font size="" color="red">否</font>
                        <#else>
                            是
                        </#if>
                    ...
                    <td >
                        <a href=" http://try.51eduline.com/index.php?app=course&mod=AdminVideo&act=lesson&vid=178 ">课时管理</a> | <a href=" http://try.51eduline.com/index.php?app=course&mod=AdminVideo&act=learn&uid=1693&id=178 ">学习记录</a> | <a href="http://try.51eduline.com/index.php?app=course&mod=AdminVideo&act=askVideo&tabHash=askVideo&id=178">提问</a> | <a href="http://try.51eduline.com/index.php?app=course&mod=AdminVideo&act=noteVideo&tabHash=noteVideo&id=178">笔记</a> | <a href="http://try.51eduline.com/index.php?app=course&mod=AdminVideo&act=reviewVideo&tabHash=reviewVideo&id=178">评价</a> | <a href="http://try.51eduline.com/index.php?app=course&mod=AdminVideo&act=addVideo&id=178&tabHash=editVideo">编辑</a> | <a href="http://try.51eduline.com/index.php?app=course&mod=AdminCourseOrder&act=addCourseOrder&id=178&tabHash=editVideo">赠送</a> | <a href="javascript:admin.enableMount(178,'Video')">允许分销</a> | <a onclick="admin.closeObject(178,'Video',0,'JAVA','1691');" href="javascript:void(0)">禁用</a> |<a onclick="admin.putawayObject(178,'down','JAVA','1691',2);" href="javascript:void(0)">立即下架</a>
                    </td>
                </tr>
            </#list>
        </table>
