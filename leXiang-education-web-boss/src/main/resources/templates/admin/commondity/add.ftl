        ...
        <form method="POST" action="../../commondity/addOrUpdate"  name='detail_form' style="margin-top:5px">
            ...
            <div class="form2">
                ...
                <dl class="lineD" id='dl_cover'>
                    ...
                    <dd>
                        <div>
                            ...
                            <input name="img" id="img" type="text" class="s-txt" style="width:200px;display: none" />
                            <!-- </FORM> -->
                        </div>
                ...
                <dl class="lineD" id='dl_info'>
                    ...
                    <dd>
                        <textarea  name="info" id="form_info" rows="10" cols="80" ></textarea>
                    </dd>
                </dl>
                ...
                <dl class="lineD" id='dl_price'>
                    ...
                    <dd>
                        <input name="price" id="form_price" type="text" value="0"  class="s-txt" style='width:200px'>
                ...
                <dl class="lineD" id='dl_stock'>
                    ...
                    <dd>
                        <input name="repertory" id="form_stock" type="text" value=""  class="s-txt" style='width:200px'>
                    </dd>
                </dl>
                <dl class="lineD" id='dl_fare'>
                    <dt><font color="red"> * </font> 运费（积分）：</dt>
                    <dd>
                        <input name="freight" id="form_fare" type="text" value="0"  class="s-txt" style='width:200px'>
                        <p>真实价格与积分兑换比例为1:100</p>
                    </dd>
                </dl>
