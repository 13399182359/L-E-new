...
<div id="container" class="so_main">
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=savePageConfig" method="POST">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr overstyle="on">
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='兑换价格'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
                    ...
                    <td width="30%"><input type="text" name='key_name[]' value='运费'  class="s-txt" style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%">
                        <select name="key_hidden[]">
                            <option value="0" selected="selected">显示</option>
                            <option value="1" >隐藏</option>
        ...
        <form action="http://try.51eduline.com/index.php?app=admin&mod=Index&act=saveSearchConfig" method="POST">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr overstyle="on" >
                    ...
                    <td width="20%"><input type="text" name='key_name[]' value='兑换价格' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%"><select name='key_type[]'>
                            <option value='text' selected="selected">文本框:input_text</option>
                            <option value='select' >下拉框:select</option>
                            <option value='radio' >单选框:radio</option>
                    ...
                    <td width="20%"><input type="text" name='key_name[]' value='运费' class="s-txt"   style="width:200px" onblur="this.className='s-txt'" onfocus="this.className='s-txt-focus'" /></td>
                    <td width="20%"><select name='key_type[]'>
                            <option value='text' selected="selected">文本框:input_text</option>
                            <option value='select' >下拉框:select</option>
                            <option value='radio' >单选框:radio</option>
    ...
    <div class="Toolbar_inbox">
        <!-- <div class="page right"><span>共22条</span> <a class='current'>1</a><a p='2' href='/index.php?app=mall&mod=AdminGoodsOrder&act=index&p=2'>2</a><a p='2' href='/index.php?app=mall&mod=AdminGoodsOrder&act=index&p=2' class='next'>下一页</a></div> -->
    ...
    <div class="list" id='list'>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <th class="line_l"   >ID</th>				<th class="line_l"   >用户名</th>				<th class="line_l"   >商品ID</th>				<th class="line_l"   >商品名称</th>				<th class="line_l"   >兑换价格</th>				<th class="line_l"   >兑换数量</th>				<th class="line_l"   >运费</th>				<th class="line_l"   >支付方式</th>				<th class="line_l"   >支付金额</th>				<th class="line_l"   >地址</th>				<th class="line_l"   >生成时间</th>				<th class="line_l"   style="width:auto;" >操作</th>		</tr>
            <#list  page.list as order>
            <tr overstyle="on" id="tr41">
                <td><input type="checkbox" value="${order.id}" onclick="admin.checkon(this)"  name="checkbox"></td>
                <td >${order.id}</td>
                <td >
                    <a event-node="face_card" uid="${order.uid}" href="http://try.51eduline.com/user/index/1669.html" class="" target="_blank">${order.uname}</a>
                </td>
                <td >37</td>
                <td >
                    <a href='../../commondity/showById?id=${order.cid}' style='color:#3b5999; ' target='_blank'>${order.cname}</a>
                </td>
                <td >${order.price}</td>
                <td >${order.countedd}</td>
                <td >${order.freight}</td>
                <td >
                    <#if order.way = 1>
                        RMB
